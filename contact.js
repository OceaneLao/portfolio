...
titleContact.setAttribute(
    'class',
    'text-center text-light mt-5 mb-1'
    );
document.body.appendChild(titleContact);

// Contact container
let contactContainer = document.createElement("div");
contactContainer.setAttribute("class", "container d-flex flex-column justify-content-center align-items-center text-center text-light");
...
document.getElementsByClassName("iconsDiv")[0].appendChild(iconGithub).style.maxHeight = "15%";
...
contactText.textContent = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.";
...
document
  .getElementsByClassName("contactForm")[0]
  .appendChild(buttonSubmit).style.backgroundColor = "#fff";
document
  .getElementsByClassName("contactForm")[0]
  .appendChild(buttonSubmit).style.padding = "15px 50px";
document
  .getElementsByClassName("contactForm")[0]
  .appendChild(buttonSubmit).style.borderRadius = "50px";
  document
  .getElementsByClassName("contactForm")[0]
  .appendChild(buttonSubmit).style.boxShadow = "5px 5px 15px #9F23C1";
